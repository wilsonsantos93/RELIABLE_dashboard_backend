 ...
 */
function isAuthorized(allowedRoles, userRole) {
 ...
 */
export function authenticateAPI(...allowed_roles) {
    return (req, res, next) => {
        ...
        // Authentication through Authorization Header allowing multiple strategies
            ...
            return passport.authenticate(['api-basic', 'api-jwt'], (error, user) => {
                if (error)
 ...
 */
export const forwardAuthenticatedAdmin = (req, res, next) => {

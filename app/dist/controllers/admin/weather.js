 ...
 */
export async function handleGetWeatherFields(request, response) {
    try {
        const projection = {};
 ...
 * @param res Client HTTP response object
 */
export async function handleDeleteAllWeather(req, res) {
    try {
 ...
 * @param res Client HTTP response object
 */
export async function handleDeleteWeather(req, res) {
    try {
